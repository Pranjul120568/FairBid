      ...
      <div className="row">
        <div className="listing-page">
          ...
          <div className="listing-page-text">
            ...
            <div>
              ...
              <h3 className="small-heading">
                {data.active ? (
                  <div>Current Price: ${data.currentPrice / 100}</div>
                ) : (
                  `Product sold at price : ${data.currentPrice / 100}$`
                )}
              </h3>
            </div>
            <form className="bidding-form" onSubmit={(e) => onSubmit(e)}>
              <div className="bid-form-group">
                <input
                  ...
                  disabled={!data.active || !auth.isAuthenticated}
                  required
                />
                <input
                  type="submit"
            ...
            {!auth.isAuthenticated ? <h5>Please login to place Bid</h5> : ""}
        ...
        <div className="listing-card-row">
          ...
          {listings.data.map((listing) => (
            // {listing == data ?  <ListingCard id={listing._id} listing={listing} />
            // : "No Items right now."}
